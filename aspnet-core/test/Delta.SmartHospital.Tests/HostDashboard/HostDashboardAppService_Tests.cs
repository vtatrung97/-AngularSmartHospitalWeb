...
using Delta.SmartHospital.MultiTenancy.HostDashboard;
...
namespace Delta.SmartHospital.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(SmartHospitalDbContext context, SubscriptionPayment subscriptionPayment)
        {
