...
using Delta.SmartHospital.Authentication.TwoFactor;
...
using Delta.SmartHospital.Web.Authentication.JwtBearer;
using Delta.SmartHospital.Web.Authentication.TwoFactor;
using Delta.SmartHospital.Web.Chat.SignalR;
using Delta.SmartHospital.Web.Common;
using Delta.SmartHospital.Web.Configuration;
using Delta.SmartHospital.Web.DashboardCustomization;

namespace Delta.SmartHospital.Web
{
    [DependsOn(
        typeof(SmartHospitalApplicationModule),
        typeof(SmartHospitalEntityFrameworkCoreModule),
    ...
    public class SmartHospitalWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public SmartHospitalWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(SmartHospitalApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SmartHospitalWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(SmartHospitalWebCoreModule).Assembly);
        }
