...
namespace Delta.SmartHospital.Web.Areas.App.Views.Shared.Themes.Default.Components.AppDefaultBrand
{
    public class AppDefaultBrandViewComponent : SmartHospitalViewComponent
    {
