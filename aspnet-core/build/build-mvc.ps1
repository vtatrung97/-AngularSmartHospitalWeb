...
$webMvcFolder = Join-Path $slnFolder "src/Delta.SmartHospital.Web.Mvc"
$webPublicFolder = Join-Path $slnFolder "src/Delta.SmartHospital.Web.Public"
...
dotnet restore Delta.SmartHospital.Web.sln
