...
using Delta.SmartHospital.Web.Areas.App.Models.Languages;
...
namespace Delta.SmartHospital.Web.Areas.App.Controllers
{
    ...
    public class LanguagesController : SmartHospitalControllerBase
    {
            ...
            string filterText = "")
        {
            ...
            {
                sourceName = SmartHospitalConsts.LocalizationSourceName;
            }
