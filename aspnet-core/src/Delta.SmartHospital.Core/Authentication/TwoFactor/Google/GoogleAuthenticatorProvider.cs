...
namespace Delta.SmartHospital.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : SmartHospitalServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Delta.SmartHospital", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
