namespace Delta.SmartHospital.Authorization
{
    ...
    public static class AppPermissions
    {
        ...
        public const string Pages_MedicalViewer = "Pages.MedicalViewer";


        public const string Pages_Meeting = "Pages.Meeting";

        public const string Pages_Patient = "Pages.Patients";
        public const string Pages_Patient_Create = "Pages.Patient.Create";
        public const string Pages_Patient_Update = "Pages.Patient.Update";
        public const string Pages_Patient_Delete = "Pages.Patient.Delete";


        public const string Pages_Administration_CodeSystems = "Pages.Administration.CodeSystems";
        public const string Pages_Administration_CodeSystems_Create = "Pages.Administration.CodeSystems.Create";
        public const string Pages_Administration_CodeSystems_Update = "Pages.Administration.CodeSystems.Update";
        public const string Pages_Administration_CodeSystems_Delete = "Pages.Administration.CodeSystems.Delete";


        public const string Pages_Administration_ValueSets = "Pages.Administration.ValueSets";
        public const string Pages_Administration_ValueSets_Create = "Pages.Administration.ValueSets.Create";
        public const string Pages_Administration_ValueSets_Update = "Pages.Administration.ValueSets.Update";
        public const string Pages_Administration_ValueSets_Delete = "Pages.Administration.ValueSets.Delete";


        public const string Pages_Administration_StructureDefinitions = "Pages.Administration.StructureDefinitions";
        public const string Pages_Administration_StructureDefinitions_Create = "Pages.Administration.StructureDefinitions.Create";
        public const string Pages_Administration_StructureDefinitions_Update = "Pages.Administration.StructureDefinitions.Update";
        public const string Pages_Administration_StructureDefinitions_Delete = "Pages.Administration.StructureDefinitions.Delete";
