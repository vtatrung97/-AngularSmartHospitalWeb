...
namespace Delta.SmartHospital.Web.Public.Startup
{
    [DependsOn(
        typeof(SmartHospitalWebCoreModule)
    )]
    public class SmartHospitalWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public SmartHospitalWebFrontEndModule(IWebHostEnvironment env, SmartHospitalEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SmartHospitalWebFrontEndModule).GetAssembly());
        }
    }
}
