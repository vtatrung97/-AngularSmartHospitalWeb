...
namespace Delta.SmartHospital.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : SmartHospitalAppServiceBase, IDashboardCustomizationAppService
    {
