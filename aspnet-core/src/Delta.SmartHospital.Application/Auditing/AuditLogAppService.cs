...
using Delta.SmartHospital.Auditing.Exporting;
...
using EntityHistoryHelper = Delta.SmartHospital.EntityHistory.EntityHistoryHelper;

namespace Delta.SmartHospital.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : SmartHospitalAppServiceBase, IAuditLogAppService
    {
