...
namespace Delta.SmartHospital.Core.Base
{
    public abstract class SmartHospitalQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected SmartHospitalQueryBase(string fieldName,
