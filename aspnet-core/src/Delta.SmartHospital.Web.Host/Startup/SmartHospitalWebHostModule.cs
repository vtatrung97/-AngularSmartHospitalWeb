...
using Delta.SmartHospital.Web.Startup.ExternalLoginInfoProviders;
...
namespace Delta.SmartHospital.Web.Startup
{
    ...
    public class SmartHospitalWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public SmartHospitalWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SmartHospitalWebHostModule).GetAssembly());
        }
