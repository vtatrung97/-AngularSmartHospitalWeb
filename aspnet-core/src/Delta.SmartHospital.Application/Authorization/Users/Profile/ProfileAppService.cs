...
using Delta.SmartHospital.Authorization.Users.Profile.Cache;
...
using Delta.SmartHospital.Gdpr;
...
{
    [AbpAuthorize]
    public class ProfileAppService : SmartHospitalAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("Delta.SmartHospital",
