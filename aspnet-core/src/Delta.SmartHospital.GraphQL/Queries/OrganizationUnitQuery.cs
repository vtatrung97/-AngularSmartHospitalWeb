...
using Delta.SmartHospital.Core.Base;
using Delta.SmartHospital.Core.Extensions;
using Delta.SmartHospital.Dto;
using Delta.SmartHospital.Types;

namespace Delta.SmartHospital.Queries
{
    public class OrganizationUnitQuery : SmartHospitalQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
