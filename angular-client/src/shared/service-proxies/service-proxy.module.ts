...
import { PatientServiceProxy } from './patientService-proxies';
import { CodeSystemServiceProxy } from './codeSystemService-proxies';
import { ValueSetServiceProxy } from './valueSetService-proxies';
import { StructureDefinitionServiceProxy } from './structureDefinitionService-proxies';
import { LocationServiceProxy } from './locationService-proxies';
import { ServiceRequestServiceProxy } from './serviceRequestService-proxies';
...
@NgModule({
    providers: [
        ...
        ApiServiceProxies.MedicalViewerAuthServiceProxy,
        ApiServiceProxies.FhirServiceProxy,
        ApiServiceProxies.MedicalViewerQueryArchiveServiceProxy,
