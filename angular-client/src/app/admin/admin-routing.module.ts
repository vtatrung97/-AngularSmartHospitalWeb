        ...
        RouterModule.forChild([
            {
                ...
                children: [
                    ...
                    {
                        path: 'CodeSystems',
                        loadChildren: () => import('./codesystems/codesystems.module').then(m => m.CodeSystemsModule),
                        data: { permission: 'Pages.Administration.CodeSystems' }
                    },
                    {
                        path: 'Dashboard',
                    ...
                    },
                    {
                        ...
                        loadChildren: () => import('./structureDefinitions/structure-definition.module').then(m => m.StructureDefinitionModule),
                        data: { permission: 'Pages.Administration.StructureDefinitions' }
                    },
                    {
                        path: 'valueSets',
                        loadChildren: () => import('./valueSets/valueSet.module').then(m => m.ValueSetModule),
                        data: { permission: 'Pages.Administration.ValueSets' }
                    },
                    {
                        path: 'valueSets/detail/:id',
                        loadChildren: () => import('./valueSets/detail/valueSetDetail.module').then(m => m.ValueSetDetailModule),
                        data: { permission: 'Pages.Administration.ValueSets' }
                    },
                    {
                        path: 'locations',
