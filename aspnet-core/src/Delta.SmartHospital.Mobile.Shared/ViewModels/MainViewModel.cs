...
using Delta.SmartHospital.Controls;
using Delta.SmartHospital.Dto;
using Delta.SmartHospital.Extensions;
using Delta.SmartHospital.Localization;
using Delta.SmartHospital.UI;
using Delta.SmartHospital.UI.Assets;
using Delta.SmartHospital.Views;
using DependencyResolver = Delta.SmartHospital.Core.Dependency.DependencyResolver;
...
namespace Delta.SmartHospital.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "SmartHospital";
