...
using Delta.SmartHospital.Identity;
using Delta.SmartHospital.Schemas;
using Delta.SmartHospital.Web.Chat.SignalR;
using Delta.SmartHospital.Web.Common;
using Delta.SmartHospital.Web.Resources;
using Swashbuckle.AspNetCore.Swagger;
using Delta.SmartHospital.Web.IdentityServer;
using Delta.SmartHospital.Web.Swagger;
using Stripe;
...
using Delta.SmartHospital.Web.HealthCheck;
using Owl.reCAPTCHA;
using HealthChecksUISettings = HealthChecks.UI.Configuration.Settings;
using Microsoft.AspNetCore.Server.Kestrel.Https;
using Microsoft.Extensions.DependencyInjection.Extensions;
using SecurityStampValidatorCallback = Delta.SmartHospital.Identity.SecurityStampValidatorCallback;

namespace Delta.SmartHospital.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            return services.AddAbp<SmartHospitalWebMvcModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "SmartHospital API V1");
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("Delta.SmartHospital.Web.wwwroot.swagger.ui.index.html");
        ...
        private void ConfigureSwagger(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new OpenApiInfo() {Title = "SmartHospital API", Version = "v1"});
                ...
                var applicationXml = $"Delta.SmartHospital.Application.xml";
                var applicationXmlPath = Path.Combine(AppContext.BaseDirectory, applicationXml);
                options.IncludeXmlComments(applicationXmlPath);

                var webCoreXmlFile = $"Delta.SmartHospital.Web.Core.xml";
