...
{
    public class SubscriptionPaymentRepository : SmartHospitalRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<SmartHospitalDbContext> dbContextProvider)
