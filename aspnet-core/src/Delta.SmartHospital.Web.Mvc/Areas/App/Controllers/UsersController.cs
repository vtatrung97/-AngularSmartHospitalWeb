...
using Delta.SmartHospital.Web.Areas.App.Models.Roles;
using Delta.SmartHospital.Web.Areas.App.Models.Users;
...
namespace Delta.SmartHospital.Web.Areas.App.Controllers
{
    [Area("App")]
    [AbpMvcAuthorize]
    public class UsersController : SmartHospitalControllerBase
    {
