...
{
    public class SessionAppService : SmartHospitalAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = SmartHospitalConsts.Currency,
                        CurrencySign = SmartHospitalConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = SmartHospitalConsts.AllowTenantsToChangeEmailSettings,
