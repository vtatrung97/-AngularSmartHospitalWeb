...
using Delta.SmartHospital.Authorization.Ldap;
...
using Delta.SmartHospital.DashboardCustomization.Definitions;
using Delta.SmartHospital.Debugging;
using Delta.SmartHospital.DynamicEntityProperties;
using Delta.SmartHospital.Features;
...
using Delta.SmartHospital.Net.Emailing;
using Delta.SmartHospital.Notifications;
using Delta.SmartHospital.WebHooks;
using Newtonsoft.Json;

namespace Delta.SmartHospital
{
    [DependsOn(
        typeof(SmartHospitalCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class SmartHospitalCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            SmartHospitalLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = SmartHospitalConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, SmartHospitalMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<SmartHospitalSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SmartHospitalCoreModule).GetAssembly());
        }
