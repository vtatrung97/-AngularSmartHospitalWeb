...
import {
    AuthenticateModel,
    MedicalViewerAuthenticateModel,
    AuthenticateResultModel,
    ExternalAuthenticateModel,
    ExternalAuthenticateResultModel,
    ExternalLoginProviderInfoModel,
    MedicalViewerAuthServiceProxy,
...
export class LoginService {
    ...
    medicalAuthenticateModel: MedicalViewerAuthenticateModel;
    ...
    constructor(
        ...
        private _medicalViewerService: MedicalViewerAuthServiceProxy
    ) {
        this.clear();
    }
    ...
    authenticateMedicalViewer(): void {
        const self = this;
        self.medicalAuthenticateModel.userName = self.authenticateModel.userNameOrEmailAddress;
        self.medicalAuthenticateModel.password = self.authenticateModel.password;
        self.medicalAuthenticateModel.userData = "";
        self._medicalViewerService.authenticate(self.medicalAuthenticateModel).subscribe({
            next: (result: string) => {
                self.processMedicalViewerAuthenticateResult(result);
            },
            error: (err: any) => {
            },
        });
    ...
    private processMedicalViewerAuthenticateResult(
        authCookie: string,
        redirectUrl?: string
    ) {
        var self = this;
        this._localStorageService.setItem("medicalViewerAuthCookie", authCookie);
        ...
        this._localStorageService.setItem(
            ...
            () => {
                if (twoFactorRememberClientToken) {
                    ...
                    this.authenticateMedicalViewer();
                }
            }
        );
    }
