...
using Delta.SmartHospital.MultiTenancy.Demo;
...
namespace Delta.SmartHospital.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
            ...
            string emailActivationLink)
        {
            ...
            {
                throw new UserFriendlyException(LocalizationManager.GetString(SmartHospitalConsts.LocalizationSourceName, "TrialWithoutEndDateErrorMessage"));
            }
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(SmartHospitalConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
