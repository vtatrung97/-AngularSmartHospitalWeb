...
using Delta.SmartHospital.EntityFrameworkCore.Repositories;

namespace Delta.SmartHospital.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : SmartHospitalRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<SmartHospitalDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
