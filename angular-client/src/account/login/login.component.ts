...
import { MedicalViewerAuthenticateModel, SessionServiceProxy, UpdateUserSignInTokenOutput } from '@shared/service-proxies/service-proxies';
...
export class LoginComponent extends AppComponentBase implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.loginService.medicalAuthenticateModel = new MedicalViewerAuthenticateModel();
    ...
    loginToMedicalViewer() {
        this.loginService.authenticateMedicalViewer();
    }
