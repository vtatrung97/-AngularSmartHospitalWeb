...
{
    public class StripeGatewayManager : SmartHospitalServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "SmartHospital";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + SmartHospitalConsts.Currency;
        }
