...
using Delta.SmartHospital.Web.Public.Startup;
using Delta.SmartHospital.Web.Session;

namespace Delta.SmartHospital.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : SmartHospitalViewComponent
    {
