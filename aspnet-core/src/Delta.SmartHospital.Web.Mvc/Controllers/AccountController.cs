...
using Delta.SmartHospital.Authentication.TwoFactor.Google;
using Delta.SmartHospital.Authorization;
using Delta.SmartHospital.Authorization.Accounts;
using Delta.SmartHospital.Authorization.Accounts.Dto;
using Delta.SmartHospital.Authorization.Delegation;
using Delta.SmartHospital.Authorization.Impersonation;
...
using Delta.SmartHospital.Net.Sms;
using Delta.SmartHospital.Notifications;
using Delta.SmartHospital.Web.Models.Account;
using Delta.SmartHospital.Security;
using Delta.SmartHospital.Security.Recaptcha;
using Delta.SmartHospital.Sessions;
using Delta.SmartHospital.Url;
using Delta.SmartHospital.Web.Authentication.External;
using Delta.SmartHospital.Web.Security.Recaptcha;
using Delta.SmartHospital.Web.Session;
using Delta.SmartHospital.Web.Views.Shared.Components.TenantChange;
using Abp.CachedUniqueKeys;
using Abp.AspNetCore.Mvc.Caching;

namespace Delta.SmartHospital.Web.Controllers
{
    public class AccountController : SmartHospitalControllerBase
    {
