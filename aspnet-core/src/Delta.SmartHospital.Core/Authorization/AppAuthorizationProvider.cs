...
namespace Delta.SmartHospital.Authorization
{
    ...
    public class AppAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            var codeSystems= administration.CreateChildPermission(AppPermissions.Pages_Administration_CodeSystems, L("CodeSystems"), multiTenancySides: MultiTenancySides.Host);
            codeSystems.CreateChildPermission(AppPermissions.Pages_Administration_CodeSystems_Create, L("CreateCodeSystem"));
            codeSystems.CreateChildPermission(AppPermissions.Pages_Administration_CodeSystems_Update, L("UpdateCodeSystem"));
            codeSystems.CreateChildPermission(AppPermissions.Pages_Administration_CodeSystems_Delete, L("DeleteCodeSystem"));

            var valueSets= administration.CreateChildPermission(AppPermissions.Pages_Administration_ValueSets, L("ValueSets"));
            valueSets.CreateChildPermission(AppPermissions.Pages_Administration_ValueSets_Create, L("CreateValueSet"));
            valueSets.CreateChildPermission(AppPermissions.Pages_Administration_ValueSets_Update, L("UpdateValueSet"));
            valueSets.CreateChildPermission(AppPermissions.Pages_Administration_ValueSets_Delete, L("DeleteValueSet"));


            var structureDefinitions = administration.CreateChildPermission(AppPermissions.Pages_Administration_StructureDefinitions, L("StructureDefinitions"));
            structureDefinitions.CreateChildPermission(AppPermissions.Pages_Administration_StructureDefinitions_Create, L("CreateStructureDefinition"));
            structureDefinitions.CreateChildPermission(AppPermissions.Pages_Administration_StructureDefinitions_Update, L("UpdateStructureDefinition"));
            structureDefinitions.CreateChildPermission(AppPermissions.Pages_Administration_StructureDefinitions_Delete, L("DeleteStructureDefinition"));

            var medicalViewer = pages.CreateChildPermission(AppPermissions.Pages_MedicalViewer, L("MedicalViewer"));


            var meeting = pages.CreateChildPermission(AppPermissions.Pages_Meeting, L("Meeting"));

            var patients = pages.CreateChildPermission(AppPermissions.Pages_Patient, L("Patients"));
            patients.CreateChildPermission(AppPermissions.Pages_Patient_Create, L("CreatePatient"));
            patients.CreateChildPermission(AppPermissions.Pages_Patient_Update, L("UpdatePatient"));
            patients.CreateChildPermission(AppPermissions.Pages_Patient_Delete, L("DeletePatient"));

        }

        private static ILocalizableString L(string name)
        {
            return new LocalizableString(name, SmartHospitalConsts.LocalizationSourceName);
        }
    }
}
