...
using Delta.SmartHospital.MultiTenancy.Payments.Paypal;
using Delta.SmartHospital.MultiTenancy.Payments.PayPal;
using Delta.SmartHospital.MultiTenancy.Payments.PayPal.Dto;

namespace Delta.SmartHospital.MultiTenancy.Payments
{
    public class PayPalPaymentAppService : SmartHospitalAppServiceBase, IPayPalPaymentAppService
    {
