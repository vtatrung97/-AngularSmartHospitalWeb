...
namespace Delta.SmartHospital.Web.Startup
{
    ...
    public class SmartHospitalWebMvcModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public SmartHospitalWebMvcModule(IWebHostEnvironment env)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SmartHospitalWebMvcModule).GetAssembly());
        }
