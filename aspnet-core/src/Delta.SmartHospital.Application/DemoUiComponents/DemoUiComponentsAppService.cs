...
using Delta.SmartHospital.DemoUiComponents.Dto;

namespace Delta.SmartHospital.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : SmartHospitalAppServiceBase, IDemoUiComponentsAppService
    {
