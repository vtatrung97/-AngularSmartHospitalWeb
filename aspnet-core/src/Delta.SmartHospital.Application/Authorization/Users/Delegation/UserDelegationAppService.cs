...
namespace Delta.SmartHospital.Authorization.Users.Delegation
{
    [AbpAuthorize]
    public class UserDelegationAppService : SmartHospitalAppServiceBase, IUserDelegationAppService
    {
