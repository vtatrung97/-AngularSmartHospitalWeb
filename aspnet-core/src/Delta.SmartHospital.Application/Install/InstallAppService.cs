...
namespace Delta.SmartHospital.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : SmartHospitalAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<SmartHospitalDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{SmartHospitalConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{SmartHospitalConsts.ConnectionStringName}", constring);
        }
