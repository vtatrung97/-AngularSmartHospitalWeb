...
using Delta.SmartHospital.Web.Areas.App.Models.DynamicEntityPropertyValues;
...
namespace Delta.SmartHospital.Web.Areas.App.Controllers
{
    ...
    public class DynamicEntityPropertyValuesController : SmartHospitalControllerBase
    {
