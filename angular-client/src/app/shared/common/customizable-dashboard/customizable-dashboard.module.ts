...
import { FindPatientRecordComponent } from '@app/shared/common/customizable-dashboard/find-patient-record/find-patient-record.component';
...
import { CustomizableDashboardRoutingModule } from './customizable-dashboard-routing.module';
...
@NgModule({
    imports: [
        ...
        CustomizableDashboardRoutingModule
    ],
