...
namespace Delta.SmartHospital.Web.Areas.App.Views.Shared.Components.AppLanguageSwitch
{
    public class AppLanguageSwitchViewComponent : SmartHospitalViewComponent
    {
