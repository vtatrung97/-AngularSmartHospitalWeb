...
using Delta.SmartHospital.DynamicEntityPropertyValues.Dto;
...
namespace Delta.SmartHospital.DynamicEntityProperties
{
    ...
    public class DynamicEntityPropertyValueAppService : SmartHospitalAppServiceBase, IDynamicEntityPropertyValueAppService
    {
