...
using Delta.SmartHospital.UiCustomization.Dto;

namespace Delta.SmartHospital.Web.TagHelpers
{
    ...
    public class SmartHospitalPageSubheaderTagHelper : TagHelper
    {
        ...
        public SmartHospitalPageSubheaderTagHelper(IUiThemeCustomizerFactory uiThemeCustomizerFactory)
        {
